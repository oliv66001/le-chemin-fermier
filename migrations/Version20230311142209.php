 ...
 */
final class Version20230311142209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE calendar (id INT AUTO_INCREMENT NOT NULL, reservation_table_id INT NOT NULL, date_start DATE NOT NULL, time_start VARCHAR(255) NOT NULL, nb_of_people INT NOT NULL, UNIQUE INDEX UNIQ_6EA9A146714ACA48 (reservation_table_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
